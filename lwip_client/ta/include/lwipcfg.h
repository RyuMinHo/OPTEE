...
/* #define USE_PCAPIF 1 */
#define LWIP_PORT_INIT_IPADDR(addr)   IP4_ADDR((addr), 127,0,0,1)
#define LWIP_PORT_INIT_GW(addr)       IP4_ADDR((addr), 0,0,0,0)
#define LWIP_PORT_INIT_NETMASK(addr)  IP4_ADDR((addr), 255,0,0,0)
